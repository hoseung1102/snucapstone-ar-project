...
> **안경 앱 본체는 [`glasses-app/`](glasses-app/)** (자기완결 Unity 프로젝트). 루트의 `*.py` 와 `db/`·`products/` 는 **Mac 측 오프라인 도구/데이터**다. 전체 맥락·history 는 [`docs/`](docs/) 참조 ([CLAUDE.md](CLAUDE.md) 의 "문서 읽는 법").
