...
8. [`docs/archive/`](docs/archive/) 는 **읽지 않아도 됨** — superseded 된 옛 기획안·핸드오프(ONBOARDING / B25_DEMO_HANDOFF / freeze-accuracy-diagnosis / findings-2026-06-11-crash-slam-openxr 등). 현재 사양으로 인용 금지.
